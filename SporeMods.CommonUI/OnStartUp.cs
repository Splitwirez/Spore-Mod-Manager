...
namespace SporeMods.CommonUI
{
	public static class OnStartUp
	{
		...
		{
			previousVersion = new Version(0,0);
			return true;
#if RESTORE_LATER
			...
			previousVersion = SmmInfo.MgrLastVersion;
			bool compatible = SmmInfo.MgrVersion >= previousVersion;

			if (compatible)
				previousVersion = SmmInfo.MgrVersion;
			else
			{
