...
namespace SporeMods.Core
{
    public class AppPaths : NOCSingleInstanceObject<AppPaths>
    {
        ...
        public async Task<bool> EnsureAllAutoDetectOK()
        {
            return (await CoreSporeData.EnsureAutoDetectOK()) && (await GalacticAdventuresData.EnsureAutoDetectOK()) && (await SporebinEP1.EnsureAutoDetectOK());
        }
    }
}
