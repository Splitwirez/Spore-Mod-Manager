...
namespace SporeMods
{
	public static class MessageDisplay
	{
		...
		public static event EventHandler<ModErrorEventArgs> ErrorOccurred;
		...
		internal static void RaiseError(ModErrorEventArgs args)
		{
			RaiseError(args, string.Empty);
		}

		internal static void RaiseError(ModErrorEventArgs args, string modName)
		{
